                ...
                imports = [
                  ...
                  (import ./nix/modules/linux {
                    inherit
                      ...
                      ;
                    homedir = linuxHomedir;
                    dotfilesDir = "${linuxHomedir}/ghq/github.com/chukyapin/dotfiles";
                  })
                ];
              }
            )
            ...
            nvim-restore = {
              ...
              program = toString (
                localPkgs.writeShellScript "nvim-restore" ''
                  : "''${DOTFILES_DIR:=${homedir}/ghq/github.com/chukyapin/dotfiles}"
                    ...
                    imports = [
                      ...
                      (import ./nix/modules/darwin {
                        inherit
                          ...
                          ;
                        homedir = darwinHomedir;
                        dotfilesDir = "${darwinHomedir}/ghq/github.com/chukyapin/dotfiles";
                      })
                    ];
                  };
              };
