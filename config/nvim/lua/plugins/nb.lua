...
local function pick_notes()
  ...
  Snacks.picker({
    ...
    win = {
      input = {
        keys = {
          ["<space>d"] = { "delete_note", mode = { "n", "i" }, desc = "Delete note" },
        },
      },
    },
  })
...
return {
  "folke/snacks.nvim",
  keys = {
    { "<space>a", add_note, desc = "nb add" },
    { "<space>A", add_note_select, desc = "nb add (select notebook)" },
    -- { "<space>i", import_image, desc = "nb import image" },
    { "<space>l", link_item, desc = "nb link" },
    { "<space>m", move_note, desc = "nb move to notebook" },
    { "<space>p", pick_notes, desc = "nb picker" },
    { "<space>g", grep_notes, desc = "nb grep" },
  },
}
